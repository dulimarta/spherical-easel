...
features:
  - title: Construct
    details: Easily construct spherical arrangements of points, lines, segments, circles, conics, and user defined curves using intersections, tangents, perpendiculars, mappings and more.
