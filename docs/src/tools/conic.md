...
## <ToolTitle title="Ellipse" iconName="ellipse" />  {#ellipse}

Create a ellipse.

::: info Creating an ellipse:
...
## <ToolTitle title="Parabola" iconName="blank" />  {#parabola}
...
## <ToolTitle title="Hyperbola" iconName="blank" />  {#hyperbola}
