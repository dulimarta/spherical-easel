...
describe("Segment Length Measurement Tool", () => {
  ...
  it("measures distance of two points", async () => {
    ...
    const distance = SEStore.seExpressions[prevMeasurementCount] as SEExpression;
  ...
  it("measures point distance", async () => {
    ...
    console.log("Observed point dist:\t" + SEStore.seExpressions[prevMeasurementCount].value + "\nExpected point dist:\t" + 0.185111);
  ...
  it("measures triangle sides", async () => {
    ...
    //tests line measurment value
    console.log("Observed tri side1:\t" + SEStore.seExpressions[prevMeasurementCount].value + "\nExpected tri side1:\t" + 0.657155);
    console.log("Observed tri side2:\t" + SEStore.seExpressions[prevMeasurementCount2].value + "\nExpected tri side2:\t" + 0.648233);
    console.log("Observed tri side3:\t" + SEStore.seExpressions[prevMeasurementCount3].value + "\nExpected tri side3:\t" + 0.704522);
