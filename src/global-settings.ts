...
export const SETTINGS = {
  ...
  circle: {
    ...
    numBoundaryPoints: 40, // This number are used to draw the edge of the circle.
    numPoints: 20, // this the number of points used to draw front (back) of the projected circle
