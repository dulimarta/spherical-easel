...
export const SETTINGS = {
  ...
  circle: {
    ...
    numPoints: 20, // This is the number of vertices that are used to draw each front/back arc of the circle, twice this number are used in the front/back fill of the circle (each part contains this many vertices)
