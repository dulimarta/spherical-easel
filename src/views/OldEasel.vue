...
export default class Easel extends Vue {
  ...
  get responsiveSize(): number {
    return 0.9 * Math.min(this.currentViewSize, this.currentViewSize);
  }
  ...
  mounted(): void {
    ...
    console.debug("Setup size is", size);
  ...
  /** This function is part of VueJS lifecyle hooks and is invoked
  ...
  onWindowResized(): void {
    ...
    console.debug("Resize factor", newScale, this.cssTransform);
    ...
    // const dx = this.currentViewSize - this.naturalViewSize;
    // this.cssTransform = `translate(${dx / 2}px,${dx / 2}px) scale(${newScale})`;
