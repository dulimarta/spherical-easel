...
export class AddAntipodalPointCommand extends Command {
  ...
  saveState(): void {
    this.lastState = this.heAntipodalPoint.id;
  }
  ...
  //   return [[this.heAntipodalPoint, this.seLabel]];
  // }
  ...
  toOpcode(): null | string | Array<string> {
    ...
    //   "objectName=" + Command.symbolToASCIIDec(this.heAntipodalPoint.name),
    //   "objectExists=" + this.heAntipodalPoint.exists,
    //   "objectShowing=" + this.heAntipodalPoint.showing,
    //   "objectFrontStyle=" +
    //     Command.symbolToASCIIDec(
    //       JSON.stringify(
    //         this.heAntipodalPoint.ref.currentStyleState(StyleCategory.Front)
    //       )
    //     ),
    //   "objectBackStyle=" +
    //     Command.symbolToASCIIDec(
    //       JSON.stringify(
    //         this.heAntipodalPoint.ref.currentStyleState(StyleCategory.Back)
    //       )
    //     ),
    ...
    //   "pointVector=" + this.heAntipodalPoint.locationVector.toFixed(9),
    //   "antipodalPointsParentName=" + this.parentHEPoint.name,
    //   "antipodalPointIsUserCreated=" + this.heAntipodalPoint.isUserCreated
    // ].join("&");
  }
