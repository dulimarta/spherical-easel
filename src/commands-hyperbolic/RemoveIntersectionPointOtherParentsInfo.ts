...
export class RemoveIntersectionPointOtherParentsInfo extends Command {
  private otherParentsInfo: HEIntersectionReturnType;

  constructor(otherParentsInfo: HEIntersectionReturnType) {
    super();
  ...
  do(): void {
    ...
    // );
    this.otherParentsInfo.HEIntersectionPoint.removeIntersectionOtherParentInfo(
      this.otherParentsInfo
    );
  }

  saveState(): void {
    this.lastState = this.otherParentsInfo.HEIntersectionPoint.id;
  }
  restoreState(): void {
    // console.debug(
    ...
    this.otherParentsInfo.HEIntersectionPoint.addIntersectionOtherParentInfo(
      this.otherParentsInfo
    );
  }
  ...
  toOpcode(): null | string | Array<string> {
    ...
    //     "intersectionPointName=" + this.otherParentsInfo.HEIntersectionPoint.name,
