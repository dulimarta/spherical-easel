...
import { AddPolarPointCommand } from "@/commands-spherical/AddPolarPointCommand";
...
import { AddPolarLineCommand } from "@/commands-spherical/AddPolarLineCommand";
  ...
  mouseMoved(event: MouseEvent): void {
    ...
    if (this.isOnSphere) {
      ...
      // The user is adding a pair of polar points
        ...
        this.temporaryPolarPointMarker2.positionVectorAndDisplay =
          this.tmpVector;
      }
    }
    // else {
