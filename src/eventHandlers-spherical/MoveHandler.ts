...
import { MovePointCommand } from "@/commands-spherical/MovePointCommand";
import { MoveLineCommand } from "@/commands-spherical/MoveLineCommand";
import { MoveSegmentCommand } from "@/commands-spherical/MoveSegmentCommand";
...
export default class MoveHandler extends Highlighter {
  ...
  mousePressed(event: MouseEvent): void {
    ...
    // We can restrict mouse press in this way because text objects can be off the sphere
  ...
  mouseMoved(event: MouseEvent): void {
    ...
    if (this.rotateSphere || this.movingSomething) {
      if (this.moveTarget instanceof SEPoint) {
        ...
        this.moveTarget.locationVector = this.currentScreenVector;
