...
describe("Point On Object Tool", () => {
  ...
  it.each([
    ...
    "adds points on a line ($lineStart,$lineEnd)",
  ...
  it.each([
    ...
    "adds points on a segment ($segStart,$segEnd)",
    async ({ segStart, segEnd }) => {
  ...
  it.each([
    ...
    "adds points on a circle ($circCtr,$circPt)",
    async ({ circCtr, circPt }) => {
