...
export const SETTINGS = {
  ...
  dollyDistanceMin: 10,
  pointsAtInfinityAngularWidth: 0.02, // The angular width of the strip at the top of the hyperboloid mesh to which points at infinity are constrained
  pointsAtInfinityAngularGap: 0.01, // The angular gap between the points at infinity strip and the edge of the hyperboloid mesh
