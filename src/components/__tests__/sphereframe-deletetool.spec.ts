...
describe("SphereFrame: Delete Tool", () => {
  ...
  describe("Delete Point", () => {
    beforeEach(async () => {
      console.debug("Before each point");
  ...
  describe("Delete lines", () => {
    beforeEach(async () => {
      console.debug("Before each line");
      wrapper = createWrapper(SphereFrame);
      SEStore.init();
    });
  ...
  describe("Delete segments", () => {
    beforeEach(async () => {
      console.debug("Before each segment");
      wrapper = createWrapper(SphereFrame);
      SEStore.init();
    });
  ...
  describe.skip("Delete circles", () => {
    beforeEach(async () => {
      console.debug("Before each circle");
      wrapper = createWrapper(SphereFrame);
      SEStore.init();
    });
    ...
    it.skip("delete circles when clicking one of its point", async () => {
      async function runDeleteCircleTest(
        isPt1Foreground: boolean,
        isPt2Foreground: boolean
      ): Promise<void> {
  ...
  describe("Delete antipodes", () => {
    beforeEach(async () => {
      console.debug("Before each antipode");
      wrapper = createWrapper(SphereFrame);
      SEStore.init();
    });
