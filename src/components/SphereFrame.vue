...
import IntersectionPointHandler from "@/eventHandlers-spherical/IntersectionPointHandler";
import AntipodalPointHandler from "@/eventHandlers-spherical/AntipodalPointHandler";
import PolarObjectHandler from "@/eventHandlers-spherical/PolarObjectHandler";
import PanZoomHandler, {
  ZoomMode
} from "@/eventHandlers-spherical/PanZoomHandler";
import DeleteHandler from "@/eventHandlers-spherical/DeleteHandler";
...
import TangentLineThruPointHandler from "@/eventHandlers-spherical/TangentLineThruPointHandler";
import EllipseHandler from "@/eventHandlers-spherical/EllipseHandler";
import IconFactoryHandler from "../eventHandlers-spherical/IconFactoryHandler";
import PolygonHandler from "@/eventHandlers-spherical/PolygonHandler";
import NSectSegmentHandler from "@/eventHandlers-spherical/NSectSegmentHandler";
import NSectAngleHandler from "@/eventHandlers-spherical/NSectAngleHandler";
import ThreePointCircleHandler from "@/eventHandlers-spherical/ThreePointCircleHandler";
import MeasuredCircleHandler from "@/eventHandlers-spherical/MeasuredCircleHandler";
import TranslationTransformationHandler from "@/eventHandlers-spherical/TranslationTransformationHandler";
import Dialog, { DialogAction } from "@/components/Dialog.vue";
import { getAuth } from "firebase/auth";

import EventBus from "@/eventHandlers-spherical/EventBus";
import MoveHandler from "../eventHandlers-spherical/MoveHandler";
...
import RotationTransformationHandler from "@/eventHandlers-spherical/RotationTransformationHandler";
import ReflectionTransformationHandler from "@/eventHandlers-spherical/ReflectionTransformationHandler";
import PointReflectionTransformationHandler from "@/eventHandlers-spherical/PointReflectionTransformationHandler";
import InversionTransformationHandler from "@/eventHandlers-spherical/InversionTransformationHandler";
// Use the DummyHandler example as a starter for a new handler
import DummyHandler from "@/eventHandlers-spherical/DummyHandler";
import TextHandler from "@/eventHandlers-spherical/TextHandler";
import { SETransformation } from "@/models-spherical/SETransformation";
import ApplyTransformationHandler from "@/eventHandlers-spherical/ApplyTransformationHandler";
...
onBeforeMount(async (): Promise<void> => {
  ...
  geoStore.setLayers(layers, null);
