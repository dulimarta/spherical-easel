...
Unfortunately `troika-three-text` doesn't appear to have official stable WebGPU support. :-(

So I'll try [three-text](https://github.com/countertype/three-text?tab=readme-ov-file)
